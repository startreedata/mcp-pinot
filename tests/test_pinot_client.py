...
from mcp_pinot.config import load_pinot_config, PinotConfig
from mcp_pinot.pinot_client import PinotClient, PinotEndpoints
...
class TestPinotClient:
    ...
    def test_test_connection_success(self, mock_pinot_config, mock_connection, mock_requests):
    ...
    def test_execute_query_http_fallback_to_pinotdb(self, mock_pinot_config, mock_connection):
